...
1. Set up your reverse proxy as shown in the [docs](/user-guide/#nginx-reverse-proxy)
2. In dispatcharr at Settings > [Network Access](/user-guide/#network-access), restrict M3U / EPG Endpoints to your local network only ( example: 192.168.1.0/24 )
3. Set up a user with XC password on the [Users](/user-guide/#users) page if you haven't already done so
