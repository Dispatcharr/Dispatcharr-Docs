...
* We plan on adding direct hardware acceleration support in future releases. For now, you can use hardware acceleration with custom ffmpeg stream profiles. This will require mapping your hardware to the container and setting up a custom ffmpeg stream profile. 