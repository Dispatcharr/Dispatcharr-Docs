La página TV Guide mostrará por defecto los canales para los que hay datos de EPG cargados.

* Puedes buscar por nombre de canal y/o filtrar por grupos de canales y perfiles.
* Haz clic en el botón `Series Rules` para gestionar reglas de grabación recurrentes de series.
    * Cualquier programa puede considerarse una serie (incluyendo títulos que son películas).
